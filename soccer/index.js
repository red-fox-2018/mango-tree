...
const Madrid = require('./club').RealMadrid;
...
// --------------------CLUB_RELEASE 1----------
let realMadrid = new Madrid('Real Madrid F.C.','Santiago Bernabeu','Madrid','Zinedine Zidane',10000000000);
...
//
let barca = new Barcelona('F.C. Barcelona','Camp Nou','Barcelona','Ernesto Valverde',20000000);
...
//   //      currentClub: 'F.C. Barcelona' } ] }
//
let liverpool = new Liverpool('Liverpool F.C.','Anfield','Liverpool','Jurgen Klopp',50000000);
...
//EXPECTED OUTPUT:
  ...
  //   players: [] }
//
let arsenal = new Arsenal('Arsenal F.C.','Emirates Stadium','London','Arsene Wenger',35000000);
// console.log(arsenal);
//EXPECTED OUTPUT:
  // Arsenal {
  //   name: 'Arsenal F.C.',
