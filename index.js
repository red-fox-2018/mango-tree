...
const objClub = require ('./club.js')
let RealMadrid = objClub.RealMadrid
let Barcelona = objClub.Barcelona
let Liverpool = objClub.Liverpool
let Arsenal = objClub.Arsenal
let Club = objClub.Club
const objLeague = require('./league.js');
let League = objLeague.League
let LaLiga = objLeague.LaLiga
let PremierLeague = objLeague.PremierLeague
